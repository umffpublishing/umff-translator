...
- KO: <K2: 그림자를 따라서>는 탁월한 기술력과 기록적인 속도 등반으로 주목받는 신예 알피니스트 Benjamin Védrines가 지금껏 가장 야심 찬 도전에 나서는 여정을 따라간다. 세계에서 가장 위험한 봉우리 중 하나인 K2를 무산소로, 빠르게 오르는 것이다. 그러나 정상 너머에는 더 개인적이고 내밀한 의미의 탐구가 기다린다. 신체적 한계를 훨씬 뛰어넘어 그를 시험하는, 내면의 산이다.
